...
def create_buttons():
    ...
    button1 = tk.Button(window, text="Exit", height= 2, width=5, command=open_file)
    button1.place(x=420, y=192)

    button2 = tk.Button(window, text="Show image(s)", height= 2, width=5, command=nav_to_loading)
    button2.place(x=341, y=267)

create_canvas()

# Load the image
front_image = Image.open("blankpage.png")
